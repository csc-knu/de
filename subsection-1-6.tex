...
Потрібно знайти розв’язок $y=y(x)$ \eqref{eq:1.6.26}, що задовольняє умовам $y(x_0)=y_0$, $y'(x_0)=y_i^\prime$, де $x_0,y_0$ -- довільні значення, а $y_i^\prime$ -- один з вибраних наперед коренів \eqref{eq:1.6.27}.
