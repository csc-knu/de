...
\begin{definition}
	Розв’язком системи диференціальних рівнянь називається набір $n$ неперервно диференційованих функцій $x_1(t), \ldots, x_n(t)$ тотожно задовольняючих кожному з рівнянь системи.
\end{definition}
...
\begin{definition}
	Розв’язок $x_1(t, C_1, \ldots, C_n), \ldots, x_n(t, C_1, \ldots, C_n)$ називається загальним, якщо за рахунок вибору сталих $C_1, \ldots, C_n$ можна розв’язати довільну задачу Коші.
\end{definition}
